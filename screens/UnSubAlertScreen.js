...
export default class UnSubAlertsScreen extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={styles.root}>
        ...
        <ImageBackground
          ...
          source={require("../assets/images/Gradient_CLPxtnw.png")}
        />
        <Text style={styles.text3}>Forex Rate Alert</Text>
        <ImageBackground
          style={styles.rect8}
          source={require("../assets/images/Gradient_CLPxtnw.png")}
        />
        <Text style={styles.text4}>Login Alert</Text>
        {/* <ImageBackground
          style={styles.rect9}
          source={require("../assets/images/Gradient_CLPxtnw.png")}
        />
        <Text style={styles.text5}>Limit Utilized Alert</Text>
        <ImageBackground
          style={styles.rect10}
          source={require("../assets/images/Gradient_CLPxtnw.png")}
        />
        <Text style={styles.text6}>Peer Beneficiary Alert</Text> */}
        <Text style={styles.text7}>Limit Threshold Alert</Text>
      </View>
    );
  }
}

UnSubAlertsScreen.navigationOptions = {
    header: null,
}
